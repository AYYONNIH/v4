...
try {
        ...
        longkapnye = "\n".repeat(420)
        tekuss = `\`\`\BEWARE SOMEONE USE BUG!\`\`\`${longkapnye}\`\`\`@⁨${nums.split('@')[0]} Terdeteksi Telah Mengirim Bug, @⁨${nums.split('@')[0]} Akan Dikick!\`\`\`\n`
...
{buttonId:`iklan`, buttonText: {displayText: 'INFO BOT🗿'}, type: 1}
]
const menuu = {
    contentText: `${tod}`,
    footerText: `${tod2}`,
...
⍟ ────────────────── ⍟`
buttons = [
{buttonId:`infobot`, buttonText: {displayText: 'infobot️'}, type: 1},
{buttonId:`owner`, buttonText: {displayText: 'Owner Bot'}, type: 1}
]
const scbott = {
    contentText: `${anu}`,
